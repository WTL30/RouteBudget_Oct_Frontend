...
export default function JobMarketPage() {
  ...
  const fetchJobs = async () => {
    ...
    try {
      const token = getAuthToken();
      const res = await fetch("https://spi.routebudget.com/api/jobMarket/getAlljobs", {
        headers: {
  ...
  const handleAcceptJob = async (jobId) => {
    ...
    try {
      ...
      const res = await fetch(`https://spi.routebudget.com/api/jobMarket/accept-job/${jobId}`, {
        method: "PUT",
        headers: {
          "Authorization": `Bearer ${token}`
        },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const token = getAuthToken();
      const res = await fetch("https://spi.routebudget.com/api/jobMarket/job-post", {
        method: "POST",
        headers: {
